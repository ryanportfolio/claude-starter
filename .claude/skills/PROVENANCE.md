...
into context — reference for maintainers and public users.
...
| `dispatching-parallel-agents` | obra/superpowers | MIT (in folder) | — |
| `executing-plans` | obra/superpowers | MIT (in folder) | — |
| `finishing-a-development-branch` | obra/superpowers | MIT (in folder) | — |
| `subagent-driven-development` | obra/superpowers | MIT (in folder) | Parallel-dispatch mode; implementer/reviewer prompt files |
| `systematic-debugging` | obra/superpowers | MIT (in folder) | — |
| `test-driven-development` | obra/superpowers | MIT (in folder) | — |
| `using-git-worktrees` | obra/superpowers | MIT (in folder) | — |
| `using-superpowers` | obra/superpowers | MIT (in folder) | — |
| `verification-before-completion` | obra/superpowers | MIT (in folder) | — |
| `writing-plans` | obra/superpowers | MIT (in folder) | — |
| `writing-skills` | obra/superpowers | MIT (in folder) | — |
